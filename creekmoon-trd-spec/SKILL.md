...
version: 1.3.0
description: 技术实现文档（TRD）写作规范，用于编写或迭代技术方案，并在初版 TRD 中原生包含“最终落地实现方案”。Make sure to use this skill whenever the user asks for 技术实现文档、TRD、技术方案、落地方案、最终实现方案、方案收束、实现决策说明，尤其适用于需要说明现状切入点、模块边界、接口契约、最终决策、代码架构与实现细节、风险实际影响、最小修改范围，以及需要梳理数据库结构调整、外部编排 DAG、配置等外部变更项的场景。
---
...
- **2026-07-29**：新增"外部变更项"章节规范，把数据库结构调整、外部编排 DAG、配置与基础设施等需要在代码之外人工执行的动作显式纳入落地方案。
